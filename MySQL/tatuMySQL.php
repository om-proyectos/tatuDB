...
class tatuMySQL extends tatuGenerico{
	...
	*/
	public function traerListadoCompleto(array $arraySQL):array{
		...
		try {
			...
			$retorno['pagina']			= ($arraySQL['limite']['registrosPorPagina'] >0 )? $arraySQL['limite']['inicio']/$arraySQL['limite']['registrosPorPagina']:0;
			$retorno['totalPaginas']	= ($arraySQL['limite']['registrosPorPagina'] >0 )? ceil($retorno['totalRegistros']/$arraySQL['limite']['registrosPorPagina']):0;
	...
	* @return array Estructura estándar del resultado de la operación.
	*/
	public function realizarUpdate($arraySQL):array{
	...
	*
	*/
	public function realizarDelete($arraySQL):array{
